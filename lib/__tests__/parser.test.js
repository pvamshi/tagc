...
describe("parser.ts", function () {
    ...
    it("should parse excludeTags and includeTags", function () {
        var hashtags = parser_1.parseTags("a simple #text with lot of #hashtags +todo +text -header");
    ...
    test("`removeDuplicates` should remove duplicate elements in array", function () {
        expect(parser_1.removeDuplicates(["abc", "def", "abc"])).toEqual(["abc", "def"]);
    });
    ...
    test("`mergeText` to merge two text array blocks", function () {
        var temp = parser_1.mergeText("line 0\nline 1\nline2\nline3\nline4\nline5\nline6\nline7\nline8\nline9\nline10".split("\n"), ["merge text1", "merge text 2", "merge text 3"], [0, 5, 8]);
        expect(temp).toEqual("line 0\nmerge text1\n---\nline 1\nline2\nline3\nline4\nline5\nmerge text 2\n---\nline6\nline7\nline8\nmerge text 3\n---\nline9\nline10\n");
    });
    ...
    describe("`getTargetBlocks` should give targetblock for a text", function () {
        ...
        test("for end block", function () {
            var resultForEnd = parser_1.getTargetBlocksType("-asdfsdfasdf asd saf asdfs.asdf asd@*&^*@$#@ ::asf234sdf534sdsd::");
