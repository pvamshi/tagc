...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Hashtag$ebnf$1$subexpression$1$ebnf$1", "symbols": ["Hashtag$ebnf$1$subexpression$1$ebnf$1", /[\s\S]/], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Hashtag$ebnf$1$subexpression$1", "symbols": ["Hashtag$ebnf$1$subexpression$1$ebnf$1", {"literal":" "}]},
