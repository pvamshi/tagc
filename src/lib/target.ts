...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "StartLine", "symbols": ["AnyText", "StartTag"], "postprocess": d=>({ type:"start" , value:d[1]})},
    {"name": "EndLine", "symbols": ["AnyText", "EndTag"], "postprocess": d=>({ type:"end" , value:{text : d[0], id: d[1]}})},
    ...
    {"name": "EndTag", "symbols": ["EndTag$string$1", "EndTag$ebnf$1", "EndTag$string$2"], "postprocess": d => d[1].join('')},
